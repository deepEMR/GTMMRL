...
data_dir = '/home/caoyu/project/GraphCLHealth/data/mimiciii'
# Path to the generated mimic.db. No need to update.
# out_dir = 'mimic_db'


# data_dir = '/home/caoyu/project/MedGTX/preprocessing/legacy/13-01-2021/mimic_table'
# Path to the generated mimic.db. No need to update.
out_dir = '/home/caoyu/project/MedGTX/preprocessing/legacy/13-01-2021/mimic_db'
...
data_demo_sample = data_demo.sample(2000, random_state=0)
